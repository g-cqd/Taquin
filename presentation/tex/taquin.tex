...
\begin{itemize}
\item \lbrack3, 4, 0, 7, 2, 1, 8, 6, 5\rbrack
\item \lbrack5, 4, 3, 0, 7, 1, 2, 6, 8\rbrack
\item \lbrack8, 4, 5, 7, 0, 6, 3, 1, 2\rbrack
\item \lbrack0, 3, 8, 4, 6, 1, 7, 5, 2\rbrack
\item \lbrack6, 7, 5, 4, 8, 2, 0, 3, 1\rbrack
\item \lbrack6, 2, 5, 3, 4, 7, 1, 0, 8\rbrack
\item \lbrack3, 6, 5, 0, 1, 4, 8, 2, 7\rbrack
\item \lbrack3, 0, 6, 1, 8, 2, 5, 7, 4\rbrack
\item \lbrack2, 5, 7, 0, 1, 6, 8, 3, 4\rbrack
\item \lbrack0, 2, 8, 1, 4, 5, 6, 3, 7\rbrack
\end{itemize}
...
\begin{itemize}
\item \lbrack 0, 7, 3, 12, 14, 13, 5, 9, 10, 6, 11, 15, 1, 2, 8, 4\rbrack
\item \lbrack 5, 14, 3, 9, 2, 0, 10, 1, 4, 15, 11, 6, 13, 7, 8, 12\rbrack
\item \lbrack 1, 12, 8, 7, 2, 10, 3, 9, 0, 6, 5, 14, 4, 11, 13, 15\rbrack
\item \lbrack 13, 11, 12, 8, 15, 1, 0, 3, 7, 14, 9, 4, 5, 2, 6, 10\rbrack
\item \lbrack 9, 2, 4, 14, 3, 11, 8, 15, 12, 5, 1, 7, 13, 0, 6, 10\rbrack
\item \lbrack 14, 7, 8, 11, 10, 6, 1, 12, 15, 0, 5, 3, 9, 2, 13, 4\rbrack
\item \lbrack 4, 7, 5, 0, 13, 11, 1, 12, 15, 10, 9, 3, 8, 2, 14, 6\rbrack
\item \lbrack 14, 12, 11, 6, 9, 15, 3, 1, 2, 5, 10, 13, 8, 4, 0, 7\rbrack
\item \lbrack 2, 3, 14, 8, 0, 9, 13, 6, 10, 4, 7, 1, 15, 12, 5, 11\rbrack
\item \lbrack 7, 15, 2, 12, 1, 6, 5, 3, 10, 4, 11, 14, 13, 0, 8, 9\rbrack
\end{itemize}
...
\paragraph{}{Tout d'abord, nous pouvons observer que lors de l'utilisation simultanée de toutes les heuristiques, l'algorithme sur-estime grandement le chemin et par conséquent le nombre de coup moyen est très élevé.}
\section{TAQUINS 5*5}
\section{Implémentation d'un autre algorithme de recherche}
%\paragraph{L'algorithme IDA*}{Nous avons choisi d'implémenter une variante de l'algorithme A* : IDA*. Son fonctionnement est plus ou moins semblable à celui de A* mais avec un approfondissement itératif.}
%Quant à lui, utilise comme limite de l'horizon de recherche la valeur de la fonction heuristique f(n)
%Chaque itération de IDA* est une recherche en profondeur qui étend tous les nœuds à l'intérieur d'un contour délimité par la valeur courante de flimite en regardant par dessus cette limite pour savoir où se trouvera la prochaine valeur de f
%limite
